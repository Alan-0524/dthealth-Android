...
public class DigitalUserModel{
    ...
    private float minBloodPressure = 60; //60-100
    private float maxBloodPressure = 100;

    private float minHeartbeatStrength = 70;
    private float maxHeartbeatStrength = 100;

    private float minHeartbeat = 50;
    private float maxHeartbeat = 120;

    private float minBloodFat = 7;
    private float maxBloodFat = 10;

    private float minBloodGlucose = 10;
    private float maxBloodGlucose = 70;

    private float minTemperature = 35;
    private float maxTemperature = 37;
